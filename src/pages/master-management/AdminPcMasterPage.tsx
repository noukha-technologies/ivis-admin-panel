...
const AdminPcMasterPage: React.FC = () => {
  ...
  const columns = useMemo<ColumnDef<ApiAdminPc>[]>(() => [
    {
      id: 'name',
      header: 'Name',
      accessorKey: 'name',
    ...
    <div className="w-full flex flex-col relative">
      {isLoading ? (
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-100 bg-[#F9FAFB]">
                ...
                <th className="px-5 py-3 text-[14px] text-[#667085] font-semibold" style={{ padding: '12px 20px', width: '21%' }}>LP Address</th>
                ...
                <th className="px-5 py-3 text-[14px] text-[#667085] font-semibold" style={{ padding: '12px 20px', width: '10%' }}>Created</th>
        ...
        <DataTable
          data={pcs}
          columns={columns}
          searchPlaceholder="Search Admin PC..."
          defaultPageSize={8}
          filterElement={
            <button
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3.5 py-2.5 border border-[#d0d5dd] rounded-xl text-[14px] text-[#101828] placeholder-[#98a2b3] focus:outline-none focus:ring-2 focus:ring-neutral-100 focus:border-neutral-400 transition-all shadow-sm resize-none"
                  />
                </div>
                ...
                <div className="flex items-center justify-between py-2 border-t border-b border-neutral-50">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[12.5px] text-[#667085]">Set the operational status of the admin PC</span>
                  </div>
                  <button
                    type="button"
                    disabled={isSubmitting}
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setFormData({ ...formData, description: e.target.value })}
                    rows={3}
                    className="w-full px-3.5 py-2.5 border border-[#d0d5dd] rounded-xl text-[14px] text-[#101828] placeholder-[#98a2b3] focus:outline-none focus:ring-2 focus:ring-neutral-100 focus:border-neutral-400 transition-all shadow-sm resize-none disabled:bg-neutral-50 disabled:text-neutral-400"
                  />
                </div>
        ...
        <div className="fixed inset-0 bg-[#0b0f19]/40 backdrop-blur-[2px] flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-100 border border-neutral-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 text-center">
              ...
              <h3 className="text-[17px] font-bold text-neutral-800 mb-1">Delete Admin PC</h3>
