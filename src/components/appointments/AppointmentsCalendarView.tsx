...
export const AppointmentsCalendarView: React.FC<AppointmentsCalendarViewProps> = ({
  ...
  return (
    <div className="bg-white border border-neutral-200 rounded-2xl shadow-sm overflow-hidden">
      <style>{`
        /* Scoped styles to match custom calendar UI design */
        .rbc-calendar {
        ...
        /* Day number placement to top-left and styling bold */
        .rbc-date-cell {
        ...
        /* Spacing for events inside the cell */
        .rbc-row-content {
        ...
        /* Hide off-range default blue background and highlight today */
        .rbc-off-range-bg {
